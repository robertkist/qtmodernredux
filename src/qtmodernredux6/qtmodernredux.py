...
import qtmodernredux6.resources.qt_resources  # pylint: disable=unused-import
from qtmodernredux6.windowstyle.modernwindow import ModernWindow, WINDOW_BUTTONS_LEFT, WINDOW_BUTTONS_RIGHT
